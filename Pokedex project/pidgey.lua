...
local previousPage = widget.newButton(
	...
	--size and type data
	local types = display.newText("Types: Normal and Flying. \n\nHeight: 1 feet and 0 inches    Weight 4.0 lbs \n\nGender ratio: 50% are male, 50% are \nfemale", display.contentWidth/2, 155, native.systemFont, 15)
	types:setFillColor (0,0,0)
	sceneGroup: insert(types)
	local Evolution = display.newText("Pidgey evolves into Pidgeotto at level 18. \nIt then evolves into Pidgeot at level 36.", display.contentWidth/2, 305, 310,0,right, native.systemFont, 15)
	Evolution:setFillColor (0,0,0)
	sceneGroup: insert(Evolution)
	local weakness = display.newText("Pidgey is (2x damage) weak to rock, electric and ice types. \nIt is immune to ground and ghost. \nIt is resistant (1/2x damage) to Bug and grass.", display.contentWidth/2, 380 ,310,0, right, native.systemFont, 15)
