...
-- Dragonite page 3 for the pokedex
...
local previousPage = widget.newButton(
	...
	local GoldEntry = display.newText("It is said that this Pokémon constantly flies over the immense seas and rescues drowning people.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	local SilverEntry = display.newText("This marine Pokémon has an impressive build that lets it freely fly over raging seas without trouble.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	local CrystalEntry = display.newText("It is said that somewhere in the ocean lies an island where these gather. Only they live there.", display.contentWidth/2, 400,310,0,right, native.systemFont, 15)
