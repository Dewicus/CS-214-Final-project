...
local previousPage = widget.newButton(
	...
	local blEntry = display.newText("It eats its weight in leaves every day. It fends off attackers with the needle on its head.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(x)
	local xEntry = display.newText("Often found in forests and grasslands. It has a sharp, toxic barb of around two inches on top of its head.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(y)
	local yEntry = display.newText("Its poison stinger is very powerful. Its bright-colored body is intended to warn off its enemies.", display.contentWidth/2, 405,310,0,right, native.systemFont, 15)
