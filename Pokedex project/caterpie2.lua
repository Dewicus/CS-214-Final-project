...
-- Caterpie page 1 for the pokedex
...
local previousPage = widget.newButton(
	...
	local redblueEntry = display.newText("Its short feet are tipped with suction pads that enable it to tirelessly climb slopes and walls.", display.contentWidth/2, 170, 310,0,right,native.systemFont, 15)
	...
	local yellowEntry = display.newText("If you touch the feeler on top of its head, it will release a horrible stink to protect itself.", display.contentWidth/2, 350,310,0,right, native.systemFont, 15)
