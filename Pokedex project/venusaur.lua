...
local previousPage = widget.newButton(
	...
	--size and type data
	local types = display.newText("Types: Grass and poison. \n\nHeight: 6 feet and 7 inches    Weight 220.5 lbs \n\nGender ratio: 87.5% are male, 12.5% are \nfemale", display.contentWidth/2, 155, native.systemFont, 15)
	types:setFillColor (0,0,0)
	sceneGroup: insert(types)        
									--Bulbasuar               Ivysaur                   level                      Venusaur             level
	local Evolution = display.newText("Venusaur is the final evolution of Bulbasaur and Ivysaur.", display.contentWidth/2, 302, 310,0,right, native.systemFont, 15)
	Evolution:setFillColor (0,0,0)
	sceneGroup: insert(Evolution)						
	--or none can be typed in if no types
	local weakness = display.newText("Venusaur is (2x damage) weak to flying, fire, psychic and ice types. \nIt is immune to none. \nIt is resistant (1/2x damage) to fighting, water, electric and fairy and takes 1/4 damage from grass", display.contentWidth/2, 375 ,310,0, right, native.systemFont, 15)
