...
-- Dratini page 6 for the pokedex
...
local previousPage = widget.newButton(
	...
	local basestatsEntry = display.newText("41 \n64 \n45 \n\n\n\n\n\n\n50 \n50 \n50 \n300", display.contentWidth*(11/16), 250, native.systemFont, 15)
	basestatsEntry:setFillColor (0,0,0)
	sceneGroup: insert(basestatsEntry)
