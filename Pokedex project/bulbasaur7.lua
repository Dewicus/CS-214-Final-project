...
-- Bulbasaur page 7 for the pokedex
...
local previousPage = widget.newButton(
	...
	--levels
	local lvl = display.newText("Level: \n\n   1\n   3\n   7\n   9\n   13\n   13\n   15\n   19\n   21\n   25\n   27\n   31\n   33\n   37", display.contentWidth/10, display.contentHeight/1.7777, native.systemFont, 13)
	lvl:setFillColor (0,0,0)
	sceneGroup: insert(lvl)
	--Attack name
	local move = display.newText("       Move:\n\n       Takle\n       Growl\n  Leech Seed\n    Vine Whip\nPoison powder\n Sleep Powder\n   Take Down\n   Razor Leaf\n  Sweet Scent\n      Growth\n  Double-Edge\n   Worry Seed\n     Synthisis\n   Seed Bomb", display.contentWidth*(3/10), 270, native.systemFont, 13)
	...
	--power of move
	local power = display.newText("Power:\n\n   50\n\n\n   45\n\n\n   90\n   55\n\n\n  120\n\n\n   80", display.contentWidth*(6.8/10), display.contentHeight/1.7777, native.systemFont, 13)
