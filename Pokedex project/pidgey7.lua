...
local previousPage = widget.newButton(
	...
	--levels
	local lvl = display.newText("Level: \n\n   1\n   5\n   9\n   13\n   17\n   21\n   25\n   29\n   33\n   37\n   41\n   45\n   49\n   53", display.contentWidth/10, display.contentHeight/1.7777, native.systemFont, 13)
	lvl:setFillColor (0,0,0)
	sceneGroup: insert(lvl)
	--Attack name
	local move = display.newText("       Move:\n\n        Takle\n  Sand Attack\n        Gust\n  Quick Attack\n   Whirlwind\n      Twister\nFeather Dance\n       Agility\n  Wing Attack\n      Roost\n    Tailwind\n  Mirror Move\n    Air Slash\n   Hurricane", display.contentWidth*(3/10), 270, native.systemFont, 13)
	move:setFillColor (0,0,0)
	sceneGroup: insert(move)
	--move type
	local Type = display.newText(" Type:\n\nNormal\nGround\n Flying\nNormal\nNormal\nDragon\n Flying\nPsychic\n Flying\n Flying\n Flying\n Flying\n Flying\n Flying", display.contentWidth*(5.3/10), display.contentHeight/1.7777, native.systemFont, 13)
	...
	--move accuracy
	local accuracy = display.newText(" Acc.:\n\n100%\n100%\n100%\n100%\n\n100%\n100%\n\n100%\n\n\n\n 95%\n 70%", display.contentWidth*(8.2/10), display.contentHeight/1.7777, native.systemFont, 13)
