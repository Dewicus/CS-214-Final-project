...
-- Charizard page 3 for the pokedex
...
local previousPage = widget.newButton(
	...
	local GoldEntry = display.newText("If Charizard becomes furious, the flame at the tip of its tail flares up in a whitish-blue color.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	local SilverEntry = display.newText("Breathing intense, hot flames, it can melt almost anything. Its breath inflicts terrible pain on enemies.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	local CrystalEntry = display.newText("It uses its wings to fly high. The temperature of its fire increases as it gains experience in battle.", display.contentWidth/2, 405,310,0,right, native.systemFont, 15)
