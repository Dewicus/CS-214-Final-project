...
-- Pidgeotto page 7 for the pokedex
...
local previousPage = widget.newButton(
	...
	--levels
	local lvl = display.newText("Level: \n\n   1\n   1\n   1\n   5\n   9\n   13\n   17\n   22\n   27\n   32\n   37\n   42\n   47\n   52\n   57\n   62", display.contentWidth/10, display.contentHeight/1.81, native.systemFont, 13)
	lvl:setFillColor (0,0,0)
	sceneGroup: insert(lvl)
	--Attack name
	local move = display.newText("       Move:\n\n        Takle\n  Sand Attack\n        Gust\n  Sand Attack\n        Gust\n  Quick Attack\n   Whirlwind\n      Twister\nFeather Dance\n       Agility\n  Wing Attack\n      Roost\n    Tailwind\n  Mirror Move\n    Air Slash\n   Hurricane", display.contentWidth*(3/10), display.contentHeight/1.81, native.systemFont, 13)
	move:setFillColor (0,0,0)
	sceneGroup: insert(move)
	--move type
	local Type = display.newText(" Type:\n\nNormal\nGround\n Flying\nGround\n Flying\nNormal\nNormal\nDragon\n Flying\nPsychic\n Flying\n Flying\n Flying\n Flying\n Flying\n Flying", display.contentWidth*(5.3/10), display.contentHeight/1.81, native.systemFont, 13)
	Type:setFillColor (0,0,0)
	sceneGroup: insert(Type)
	--power of move
	local power = display.newText("Power:\n\n   50\n\n   40\n\n   40\n   40\n\n   40\n\n\n   60\n\n\n\n   75\n  110", display.contentWidth*(6.8/10), display.contentHeight/1.81, native.systemFont, 13)
	power:setFillColor (0,0,0)
	sceneGroup: insert(power)
	--move accuracy
	local accuracy = display.newText(" Acc.:\n\n100%\n100%\n100%\n100%\n100%\n100%\n\n100%\n100%\n\n100%\n\n\n\n 95%\n 70%", display.contentWidth*(8.2/10), display.contentHeight/1.81, native.systemFont, 13)
	accuracy:setFillColor (0,0,0)
	sceneGroup: insert(accuracy)
	--move power points
	local pp = display.newText(" PP:\n\n 35\n 15\n 35\n 15\n 35\n 30\n 20\n 20\n 15\n 30\n 35\n 10\n 30\n 20\n 20\n 10", display.contentWidth*(9.5/10), display.contentHeight/1.81, native.systemFont, 13)
