...
-- Venusaur page 5 for the pokedex
...
local previousPage = widget.newButton(
	...
	local blEntry = display.newText("After a rainy day, the flower on its back smells stronger. The scent attracts other Pokémon.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(x)
	local xEntry = display.newText("By spreading the broad petals of its flower and catching the sun's rays, it fills its body with power.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(y)
	local yEntry = display.newText("After a rainy day, the flower on its back smells stronger. The scent attracts other Pokémon.", display.contentWidth/2, 405,310,0,right, native.systemFont, 15)
