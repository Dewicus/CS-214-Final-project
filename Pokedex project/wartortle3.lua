...
-- Wartortle page 3 for the pokedex
...
local previousPage = widget.newButton(
	...
	local GoldEntry = display.newText("It is recognized as a symbol of longevity. If its shell has algae on it, that Wartortle is very old.", display.contentWidth/2, 180,310,0,right, native.systemFont, 15)
	...
	local SilverEntry = display.newText("It cleverly controls its furry ears and tail to maintain its balance while swimming.", display.contentWidth/2, 325,310,0,right, native.systemFont, 15)
	...
	local CrystalEntry = display.newText("Its long, furry tail is a symbol of longevity, making it quite popular among older people.", display.contentWidth/2, 405,310,0,right, native.systemFont, 15)
