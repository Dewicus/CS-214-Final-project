...
-- Pidgeotto page 1 for the pokedex
...
local previousPage = widget.newButton(
	...
	local redblueEntry = display.newText("Very protective of its sprawling territorial area, this Pokémon will fiercely peck at any intruder.", display.contentWidth/2, 170, 310,0,right,native.systemFont, 15)
	...
	local yellowEntry = display.newText("This Pokémon is full of vitality. It constantly flies around its large territory in search of prey.", display.contentWidth/2, 350,310,0,right, native.systemFont, 15)
