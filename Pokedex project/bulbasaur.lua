...
-- Bulbasaur page 1 for the pokedex
...
local previousPage = widget.newButton(
	...
	--size and type data
	local types = display.newText("Types: Grass and poison. \n\nHeight: 2 feet and 4 inches    Weight 15.2 lbs \n\nGender ratio: 87.5% are male, 12.5% are \nfemale", display.contentWidth/2, 155, native.systemFont, 15)
	types:setFillColor (0,0,0)
	sceneGroup: insert(types)
	local Evolution = display.newText("Bulbasaur evolves into Ivysaur at level 16. \nIt then evolves into Venusaur at level 32.", display.contentWidth/2, 305, 310,0,right, native.systemFont, 15)
	Evolution:setFillColor (0,0,0)
	sceneGroup: insert(Evolution)
	local weakness = display.newText("Bulbasaur is (2x damage) weak to flying, fire, psychic and ice types. \nIt is immune to none. \nIt is resistant (1/2x damage) to fighting, water, electric and fairy. It takes 1/4 damage from grass.", display.contentWidth/2, 380 ,310,0, right, native.systemFont, 15)
