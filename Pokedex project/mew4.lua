...
local previousPage = widget.newButton(
	...
	local rseEntry = display.newText("Mew is said to possess the genetic composition of all Pokémon. It is capable of making itself invisible at will, so it entirely avoids notice even if it approaches people.", display.contentWidth/2, 160,312,0,right, native.systemFont, 15)
	...
	local dppEntry = display.newText("Because it can use all kinds of moves, many scientists believe Mew to be the ancestor of Pokémon.", display.contentWidth/2, 370,310,0,right, native.systemFont, 15)
