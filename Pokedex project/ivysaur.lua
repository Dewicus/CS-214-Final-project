...
local previousPage = widget.newButton(
	...
	--size and type data
	local types = display.newText("Types: Grass and poison. \n\nHeight: 3 feet and 3 inches    Weight 28.7 lbs \n\nGender ratio: 87.5% are male, 12.5% are \nfemale", display.contentWidth/2, 155, native.systemFont, 15)
	types:setFillColor (0,0,0)
	sceneGroup: insert(types)        
									--Bulbasuar               Ivysaur                   level                      Venusaur             level
	local Evolution = display.newText("Ivysaur evolves into Venusaur at level 32. ", display.contentWidth/2, 305, 310,0,right, native.systemFont, 15)
	Evolution:setFillColor (0,0,0)
	sceneGroup: insert(Evolution)						
	--or none can be typed in if no types
	local weakness = display.newText("Ivysaur is (2x damage) weak to flying, fire, psychic and ice types. \nIt is immune to none. \nIt is resistant (1/2x damage) to fighting, water, grass, electric and fairy.", display.contentWidth/2, 380 ,310,0, right, native.systemFont, 15)
