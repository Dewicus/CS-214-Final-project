...
local previousPage = widget.newButton(
	...
	--size and type data
	local types = display.newText("Types: Fire. \n\nHeight: 2 feet and 0 inches    Weight 18.7 lbs \n\nGender ratio: 87.5% are male, 12.5% are \nfemale", display.contentWidth/2, 155, native.systemFont, 15)
	types:setFillColor (0,0,0)
	sceneGroup: insert(types)
	local Evolution = display.newText("Charmander evolves into Charmeleon at level 16. \nIt then evolves into Charizard at level 36.", display.contentWidth/2, 310, 310,0,right, native.systemFont, 15)
	Evolution:setFillColor (0,0,0)
	sceneGroup: insert(Evolution)
	local weakness = display.newText("Charmander is (2x damage) weak to ground, rock and water types. \nIt is immune to none. \nIt is resistant (1/2x damage) to bug, steel, grass, fire, ice and fairy.", display.contentWidth/2, 385 ,310,0, right, native.systemFont, 15)
