...
-- Wartortle page 7 for the pokedex
...
local previousPage = widget.newButton(
	...
	--levels
	local lvl = display.newText("Level: \n\n   1\n   1\n   1\n   4\n   7\n   10\n   13\n   16\n   20\n   24\n   28\n   32\n   36\n   40\n   44\n   48", display.contentWidth/10, display.contentHeight/1.8, native.systemFont, 13)
	lvl:setFillColor (0,0,0)
	sceneGroup: insert(lvl)
	--Attack name
	local move = display.newText("       Move:\n\n       Takle\n    Tail Whip\n   Water Gun\n    Tail Whip\n   Water Gun\n    Withdraw\n     Bubble\n       Bite\n   Rapid Spin\n     Protect\n  Water Pulse\n    Aqua Tail\n   Skull Bash\n  Iron Defense\n  Rain Dance\n  Hydro Pump", display.contentWidth*(3/10), display.contentHeight/1.8, native.systemFont, 13)
	move:setFillColor (0,0,0)
	sceneGroup: insert(move)
	--move type
	local Type = display.newText(" Type:\n\nNormal\nNormal\n Water\nNormal\n Water\n Water\n Water\n  Dark\nNormal\nNormal\n Water\n Water\nNormal\n  Steel\n Water\n Water", display.contentWidth*(5.3/10), display.contentHeight/1.8, native.systemFont, 13)
	Type:setFillColor (0,0,0)
	sceneGroup: insert(Type)
	--power of move
	local power = display.newText("Power:\n\n   50\n\n   40\n\n   40\n\n   40\n   60\n   20\n\n   60\n   90\n  130\n\n\n   110", display.contentWidth*(6.8/10), display.contentHeight/1.8, native.systemFont, 13)
	power:setFillColor (0,0,0)
	sceneGroup: insert(power)
	--move accuracy
	local accuracy = display.newText(" Acc.:\n\n100%\n100%\n100%\n100%\n100%\n\n100%\n100%\n100%\n\n100%\n 90%\n100%\n\n\n 80%", display.contentWidth*(8.2/10), display.contentHeight/1.8, native.systemFont, 13)
	accuracy:setFillColor (0,0,0)
	sceneGroup: insert(accuracy)
	--move power points
	local pp = display.newText(" PP:\n\n 35\n 30\n 25\n 30\n 25\n 40\n 30\n 25\n 40\n 10\n 20\n 10\n 10\n 15\n  5\n  5", display.contentWidth*(9.5/10), display.contentHeight/1.8, native.systemFont, 13)
