...
-- Dratini page 4 for the pokedex
...
local previousPage = widget.newButton(
	...
	local rseEntry = display.newText("Dratini continually molts and sloughs off its old skin. It does so because the life energy within its body steadily builds to reach uncontrollable levels.", display.contentWidth/2, 160,312,0,right, native.systemFont, 15)
	...
	local dppEntry = display.newText("It is called the 'Mirage Pokémon' because so few have seen it. Its shed skin has been found.", display.contentWidth/2, 370,310,0,right, native.systemFont, 15)
