...
-- Squirtle page 5 for the pokedex
...
local previousPage = widget.newButton(
	...
	local blEntry = display.newText("It shelters itself in its shell, then strikes back with spouts of water at every opportunity.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(x)
	local xEntry = display.newText("It shelters itself in its shell, then strikes back with spouts of water at every opportunity.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(y)
	local yEntry = display.newText("Shoots water at prey while in the water. Withdraws into its shell when in danger.", display.contentWidth/2, 395,310,0,right, native.systemFont, 15)
