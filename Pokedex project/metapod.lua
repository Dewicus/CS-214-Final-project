...
local previousPage = widget.newButton(
	...
	--size and type data
	local types = display.newText("Types: Bug. \n\nHeight: 2 feet and 4 inches    Weight 21.8 lbs \n\nGender ratio: 50% are male, 50% are \nfemale", display.contentWidth/2, 155, native.systemFont, 15)
	types:setFillColor (0,0,0)
	sceneGroup: insert(types)
	local Evolution = display.newText("Metapod evolves into Butterfree at level 10.", display.contentWidth/2, 305, 310,0,right, native.systemFont, 15)
	Evolution:setFillColor (0,0,0)
	sceneGroup: insert(Evolution)
	local weakness = display.newText("Metapod is (2x damage) weak to flying, fire and Rock. \nIt is immune to none. \nIt is resistant (1/2x damage) to fighting, grass and ground.", display.contentWidth/2, 380 ,310,0, right, native.systemFont, 15)
