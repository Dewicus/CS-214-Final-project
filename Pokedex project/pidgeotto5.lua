...
-- Pidgeotto page 5 for the pokedex
...
local previousPage = widget.newButton(
	...
	local blEntry = display.newText("It flies over its wide territory in search of prey, downing it with its highly developed claws.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(x)
	local xEntry = display.newText("The claws on its feet are well developed. It can carry prey such as an Exeggcute to its nest over 60 miles away.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(y)
	local yEntry = display.newText("Very protective of its sprawling territorial area, this Pokémon will fiercely peck at any intruder.", display.contentWidth/2, 405,310,0,right, native.systemFont, 15)
