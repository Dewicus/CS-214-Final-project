...
-- Charmeleon page 4 for the pokedex
...
local previousPage = widget.newButton(
	...
	local rseEntry = display.newText("Charmeleon mercilessly destroys its foes using its sharp claws. If it encounters a strong foe, it turns aggressive. In this \n\n\n\n\n\nexcited state, the flame at the tip of its tail flares with a bluish white color.", display.contentWidth/2, 227,312,0,right, native.systemFont, 15)
	...
	local dppEntry = display.newText("In the rocky mountains where Charmeleon live, their fiery tails shine at night like stars.", display.contentWidth/2, 390,310,0,right, native.systemFont, 15)
