...
local previousPage = widget.newButton(
	...
	--levels
	local lvl = display.newText("Level: \n\n   1\n   1\n   15", display.contentWidth/10, display.contentHeight/1.7777, native.systemFont, 13)
	lvl:setFillColor (0,0,0)
	sceneGroup: insert(lvl)
	--Attack name
	local move = display.newText("       Move:\n\n  Poison Sting\n   String Shot\n     Bug Bite", display.contentWidth*(3/10), 270, native.systemFont, 13)
	...
	--power of move
	local power = display.newText("Power:\n\n   15\n\n   60", display.contentWidth*(6.8/10), display.contentHeight/1.7777, native.systemFont, 13)
	...
	--move power points
	local pp = display.newText(" PP:\n\n 35\n 40\n 20", display.contentWidth*(9.5/10), display.contentHeight/1.7777, native.systemFont, 13)
