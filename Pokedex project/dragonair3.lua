...
-- Dragonair page 3 for the pokedex
...
local previousPage = widget.newButton(
	...
	local GoldEntry = display.newText("They say that if it emits an aura from its whole body, the weather will begin to change instantly.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	local SilverEntry = display.newText("Its crystalline orbs appear to give this Pokémon the power to freely control the weather.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	local CrystalEntry = display.newText("It is called the divine Pokémon. When its entire body brightens slightly, the weather changes.", display.contentWidth/2, 400,310,0,right, native.systemFont, 15)
