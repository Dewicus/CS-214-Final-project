...
-- Charmeleon page 7 for the pokedex
...
local previousPage = widget.newButton(
	...
	local backdrop = display.newRect(display.contentWidth*(2/4), display.contentHeight * (2.2/4), display.contentWidth*(7.9/8), display.contentHeight * (5/8))
	...
	local lvlattacks = display.newText("Attacks learned by leveling:", display.contentWidth/2, 125, native.systemFont, 17)
	lvlattacks:setFillColor (0,0,0)
	sceneGroup: insert(lvlattacks)
	--levels
	local lvl = display.newText("Level: \n\n   1\n   1\n   1\n   1\n   1\n   1\n   1\n   1\n   1\n   7\n   10\n   17\n   21\n   28\n   32\n   36\n   41\n   47\n   56\n   62\n   71\n   77", display.contentWidth/10, display.contentHeight/1.76, native.systemFont, 10)
	lvl:setFillColor (0,0,0)
	sceneGroup: insert(lvl)
	--Attack name
	local move = display.newText("       Move:\n\n   Flare Blitz\n   Heat Wave\n  Dragon Claw\n Shadow Claw\n    Air Slash\n      Scratch\n      Growl\n      Ember\n Smokescreen\n      Ember\n Smokescreen\n Dragon Rage\n  Scary Face\n   Fire Fang\n Flame Burst\n Wing Attack\n      Slash\n Flamethrower\n    Fire Spin\n     Inferno\n   Heat Wave\n   Flare Blitz", display.contentWidth*(3/10), display.contentHeight/1.76, native.systemFont, 10)
	move:setFillColor (0,0,0)
	sceneGroup: insert(move)
	--move type
	local Type = display.newText(" Type:\n\n Fire\n Fire\n Dragon\n Ghost\n Flying\nNormal\nNormal\n Fire\n Normal\n Fire\n Normal\nDragon\n Normal\n Fire\n Fire\n Flying\nNormal\n Fire\n Fire\n Fire\n Fire\n Fire", display.contentWidth*(5.3/10), display.contentHeight/1.76, native.systemFont, 10)
	Type:setFillColor (0,0,0)
	sceneGroup: insert(Type)
	--power of move
	local power = display.newText("Power:\n\n   120\n   95\n   80\n   70\n   75\n   40\n \n   40\n \n   40\n \n \n \n   65\n   70\n   60\n   70\n   90\n   35\n  100\n   95\n   120", display.contentWidth*(6.8/10), display.contentHeight/1.76, native.systemFont, 10)
	power:setFillColor (0,0,0)
	sceneGroup: insert(power)
	--move accuracy
	local accuracy = display.newText(" Acc.:\n\n100%\n 90%\n100%\n100%\n 95%\n100%\n100%\n100%\n100%\n100%\n100%\n100%\n100%\n 95%\n100%\n100%\n100%\n100%\n 85%\n 50%\n 90%\n100%", display.contentWidth*(8.2/10), display.contentHeight/1.76, native.systemFont, 10)
	accuracy:setFillColor (0,0,0)
	sceneGroup: insert(accuracy)
	--move power points
	local pp = display.newText(" PP:\n\n 15\n 10\n 15\n 15\n 15\n 35\n 40\n 25\n 20\n 25\n 20\n 10\n 10\n 15\n 15\n 35\n 20\n 15\n 15\n  5\n 10\n 15", display.contentWidth*(9.5/10), display.contentHeight/1.76, native.systemFont, 10)
