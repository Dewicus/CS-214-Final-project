...
-- Wartortle page 5 for the pokedex
...
local previousPage = widget.newButton(
	...
	local blEntry = display.newText("It is said to live 10,000 years. Its furry tail is popular as a symbol of longevity.", display.contentWidth/2, 170,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(x)
	local xEntry = display.newText("When tapped, this Pokémon will pull in its head, but its tail will still stick out a little bit.", display.contentWidth/2, 325,310,0,right, native.systemFont, 15)
	xEntry:setFillColor (0,0,0)
	sceneGroup: insert(xEntry)
	
	local y = display.newText("Y pokedex entry:", display.contentWidth/2, 365, native.systemFont, 17)
	y:setFillColor (0,0,0)
	sceneGroup: insert(y)
	local yEntry = display.newText("It is said to live 10,000 years. Its furry tail is popular as a symbol of longevity.", display.contentWidth/2, 395,310,0,right, native.systemFont, 15)
