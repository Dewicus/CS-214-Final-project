...
local previousPage = widget.newButton(
	...
	local blEntry = display.newText("A Pokémon created by recombining Mew's genes. It's said to have the most savage heart among Pokémon.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(x)
	local xEntry = display.newText("It was created by a scientist after years of horrific gene-splicing and DNA-engineering experiments.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(y)
	local yEntry = display.newText("A Pokémon created by recombining Mew's genes. It's said to have the most savage heart among Pokémon", display.contentWidth/2, 395,310,0,right, native.systemFont, 15)
