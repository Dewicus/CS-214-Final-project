...
-- Ivysaur page 1 for the pokedex
...
local previousPage = widget.newButton(
	...
	local redblueEntry = display.newText("When the bulb on its back grows large, it appears to lose the ability to stand on its hind legs.", display.contentWidth/2, 170, 310,0,right,native.systemFont, 15)
	...
	local yellowEntry = display.newText("The bulb on its back grows by drawing energy. It gives off an aroma when it is ready to bloom.", display.contentWidth/2, 350,310,0,right, native.systemFont, 15)
