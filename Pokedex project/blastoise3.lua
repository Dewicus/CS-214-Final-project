...
-- Blastoise page 3 for the pokedex
...
local previousPage = widget.newButton(
	...
	local GoldEntry = display.newText("It deliberately makes itself heavy so it can withstand the recoil of the water jets it fires.", display.contentWidth/2, 170,310,0,right, native.systemFont, 15)
	...
	local SilverEntry = display.newText("The rocket cannons on its shell fire jets of water capable of punching holes through thick steel.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	local CrystalEntry = display.newText("It firmly plants its feet on the ground before shooting water from the jets on its back.", display.contentWidth/2, 400,310,0,right, native.systemFont, 15)
