...
local previousPage = widget.newButton(
	...
	--Stats entries
	local basestats = display.newText("Kakuna base stats:", display.contentWidth/2, 110, native.systemFont, 17)
