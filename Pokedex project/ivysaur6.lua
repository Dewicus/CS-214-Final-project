...
-- Ivysaur page 6 for the pokedex
...
local previousPage = widget.newButton(
	...
	--Stats entries
	local basestats = display.newText("Ivysaur base stats:", display.contentWidth/2, 110, native.systemFont, 17)
