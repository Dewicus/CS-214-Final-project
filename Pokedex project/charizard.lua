...
local previousPage = widget.newButton(
	...
	--size and type data
	local types = display.newText("Types: Fire and flying. \n\nHeight: 5 feet and 7 inches    Weight 199.5 lbs \n\nGender ratio: 87.5% are male, 12.5% are \nfemale", display.contentWidth/2, 160, native.systemFont, 15)
	types:setFillColor (0,0,0)
	sceneGroup: insert(types)
	local Evolution = display.newText("Charizard is the final evolution of Charmander and Charmeleon.", display.contentWidth/2, 305, 310,0,right, native.systemFont, 15)
	Evolution:setFillColor (0,0,0)
	sceneGroup: insert(Evolution)
	local weakness = display.newText("Charizard is (2x damage) weak to water, electric types. It is 4x weak to rock. \nIt is immune to Ground. \nIt is resistant (1/2x damage) to fighting, steel, grass, fire, ice and fairy. It takes 1/4 damage from bug", display.contentWidth/2, 378 ,310,0, right, native.systemFont, 15)
