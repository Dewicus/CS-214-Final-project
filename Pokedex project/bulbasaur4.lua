...
-- Bulbasaur page 4 for the pokedex
...
local previousPage = widget.newButton(
	...
	local rseEntry = display.newText("BULBASAUR can be seen napping in bright sunlight. There is a seed on its back. By soaking up the sun's rays, the seed grows progressively larger.", display.contentWidth/2, 160,312,0,right, native.systemFont, 15)
	...
	local dppEntry = display.newText("For some time after its birth, it grows by gaining nourishment from the seed on its back.", display.contentWidth/2, 370,310,0,right, native.systemFont, 15)
