...
-- Squirtle page 1 for the pokedex
...
local previousPage = widget.newButton(
	...
	local redblueEntry = display.newText("After birth, its back swells and hardens into a shell. Powerfully sprays foam from its mouth.", display.contentWidth/2, 170, 310,0,right,native.systemFont, 15)
	...
	local yellowEntry = display.newText("Shoots water at prey while in the water. Withdraws into its shell when in danger.", display.contentWidth/2, 350,310,0,right, native.systemFont, 15)
