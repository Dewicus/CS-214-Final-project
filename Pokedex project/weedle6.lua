...
local previousPage = widget.newButton(
	...
	--Stats entries
	local basestats = display.newText("Weedle base stats:", display.contentWidth/2, 110, native.systemFont, 17)
	...
	local basestatsEntry = display.newText("40 \n35 \n30 \n\n\n\n\n\n\n20 \n20 \n50 \n195", display.contentWidth*(11/16), 250, native.systemFont, 15)
	basestatsEntry:setFillColor (0,0,0)
	sceneGroup: insert(basestatsEntry)
