...
-- Pidgeotto page 4 for the pokedex
...
local previousPage = widget.newButton(
	...
	local rseEntry = display.newText("Pidgeotto claims a large area as its own territory. This Pokémon flies around, patrolling its living space. If its territory is \n\n\n\n\n\nviolated, it shows no mercy in thoroughly punishing the foe with its sharp claws.", display.contentWidth/2, 230,312,0,right, native.systemFont, 15)
	...
	local dppEntry = display.newText("It flies over its wide territory in search of prey, downing it with its highly developed claws.", display.contentWidth/2, 390,310,0,right, native.systemFont, 15)
