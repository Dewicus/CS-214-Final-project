...
-- Butterfree page 4 for the pokedex
...
local function handleButtonEvent( event )
    if ( "ended" == event.phase ) then
		composer.gotoScene("butterfree5")
...
local previousPage = widget.newButton(
	...
	local rse = display.newText("Ruby, Sapphire and Emerald Pokedex	\n                          entries:", display.contentWidth/2, 120,310,0, native.systemFont, 17, "center") 
	rse:setFillColor (0,0,0)
	sceneGroup: insert(rse)
	local rseEntry = display.newText("Butterfree has a superior ability to search for delicious honey from flowers. It can even search out, extract, and carry honey \n\n\n\n\n\nfrom flowers that are blooming over six miles from its nest.", display.contentWidth/2, 230,312,0,right, native.systemFont, 15)
	...
	local dppEntry = display.newText("It loves the honey of flowers and can locate flower patches that have even tiny amounts of pollen.", display.contentWidth/2, 400,310,0,right, native.systemFont, 15)
