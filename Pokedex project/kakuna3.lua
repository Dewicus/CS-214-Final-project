...
local previousPage = widget.newButton(
	...
	local GoldEntry = display.newText("Although it is a cocoon, it can move a little. It can extend its poison barb if it is attacked.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	local SilverEntry = display.newText("From this form, it will grow into an adult. As its body becomes softer, the external shell hardens.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	local CrystalEntry = display.newText("Nearly incapable of movement, it leans against stout trees while waiting for its evolution.", display.contentWidth/2, 400,310,0,right, native.systemFont, 15)
