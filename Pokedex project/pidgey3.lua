...
local previousPage = widget.newButton(
	...
	local GoldEntry = display.newText("It usually hides in tall grass. Because it dislikes fighting, it protects itself by kicking up sand.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	local SilverEntry = display.newText("Common in grassy areas and forests, it is very docile and will chase off enemies by flapping up sand.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	local CrystalEntry = display.newText("It rapidly flaps its wings in the grass, stirring up a dust cloud that drives insect prey out into the open.", display.contentWidth/2, 405,310,0,right, native.systemFont, 15)
