...
-- Dragonair page 5 for the pokedex
...
local previousPage = widget.newButton(
	...
	local blEntry = display.newText("If its body takes on an aura, the weather changes instantly. It is said to live in seas and lakes.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(x)
	local xEntry = display.newText("Its crystalline orbs appear to give this Pokémon the power to freely control the weather.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(y)
	local yEntry = display.newText("A mystical Pokémon that exudes a gentle aura. It is said to have the ability to change the weather.", display.contentWidth/2, 395,310,0,right, native.systemFont, 15)
