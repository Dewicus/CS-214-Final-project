...
-- Bulbasaur page 3 for the pokedex
...
local previousPage = widget.newButton(
	...
	local GoldEntry = display.newText("The seed on its back is filled with nutrients. The seed grows steadily larger as its body grows.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	local SilverEntry = display.newText("It carries a seed on its back right from birth. As it grows older, the seed also grows larger.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	local CrystalEntry = display.newText("While it is young, it uses the nutrients that are stored in the seeds on its back in order to grow.", display.contentWidth/2, 400,310,0,right, native.systemFont, 15)
