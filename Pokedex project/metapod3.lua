...
-- Metapod page 3 for the pokedex
...
local previousPage = widget.newButton(
	...
	local GoldEntry = display.newText("Inside the shell, it is soft and weak as it prepares to evolve. It stays motionless in the shell.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	local SilverEntry = display.newText("It prepares for evolution by hardening its shell as much as possible to protect its soft body.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	local CrystalEntry = display.newText("This is its preevolved form. At this stage, it can only harden, so it remains motionless to avoid attack.", display.contentWidth/2, 400,310,0,right, native.systemFont, 15)
