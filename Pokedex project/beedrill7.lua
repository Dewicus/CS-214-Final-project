...
-- Beedrill page 7 for the pokedex
...
local previousPage = widget.newButton(
	...
	--levels
	local lvl = display.newText("Level: \n\n   1\n  10\n   13\n   16\n   19\n   22\n   25\n   28\n   31\n   34\n   37\n   40\n   45", display.contentWidth/10, display.contentHeight/1.7777, native.systemFont, 13)
	lvl:setFillColor (0,0,0)
	sceneGroup: insert(lvl)
	--Attack name
	local move = display.newText("       Move:\n\n   Fury Attack\n   Fury Attack\n Focus Energy\n    Twineedle\n       Rage\n      Pursuit\n Toxic Spikes\n   Pin Missile\n       Agility\n   Assurance\n   Poison Jab\n    Endeavor\n   Fell Stinger", display.contentWidth*(3/10), 270, native.systemFont, 13)
	move:setFillColor (0,0,0)
	sceneGroup: insert(move)
	--move type
	local Type = display.newText(" Type:\n\n\Normal\nNormal\nNormal\n  Bug\nNormal\n Dark\nPoison\n  Bug\nPsychic\n Dark\nPoison\nNormal\n  Bug", display.contentWidth*(5.3/10), display.contentHeight/1.7777, native.systemFont, 13)
	Type:setFillColor (0,0,0)
	sceneGroup: insert(Type)
	--power of move
	local power = display.newText("Power:\n\n 15\n 15\n\n 25\n 20\n 40\n\n 25\n\n 60\n 80\n\n 30", display.contentWidth*(6.8/10), display.contentHeight/1.7777, native.systemFont, 13)
	...
	--move power points
	local pp = display.newText(" PP:\n\n 20\n 20\n 30\n 20\n 20\n 20\n 20\n 20\n 30\n 10\n 20\n  5\n 25", display.contentWidth*(9.5/10), display.contentHeight/1.7777, native.systemFont, 13)
