...
-- Pidgeotto page 6 for the pokedex
...
local previousPage = widget.newButton(
	...
	--Stats entries
	local basestats = display.newText("Pidgeotto base stats:", display.contentWidth/2, 110, native.systemFont, 17)
	...
	local basestatsEntry = display.newText("63 \n60 \n55 \n\n\n\n\n\n\n50 \n50 \n71 \n349", display.contentWidth*(11/16), 250, native.systemFont, 15)
	basestatsEntry:setFillColor (0,0,0)
	sceneGroup: insert(basestatsEntry)
