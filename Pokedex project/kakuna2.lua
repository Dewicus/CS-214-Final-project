...
local previousPage = widget.newButton(
	...
	local redblueEntry = display.newText("Almost incapable of moving, this Pokémon can only harden its shell to protect itself from predators.", display.contentWidth/2, 170, 310,0,right,native.systemFont, 15)
	...
	local yellowEntry = display.newText("Able to move only slightly. When endangered, it may stick out its stinger and poison its enemy.", display.contentWidth/2, 350,310,0,right, native.systemFont, 15)
