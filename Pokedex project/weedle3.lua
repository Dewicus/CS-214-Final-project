...
local previousPage = widget.newButton(
	...
	local GoldEntry = display.newText("Its poison stinger is very powerful. Its bright-colored body is intended to warn off its enemies.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	local SilverEntry = display.newText("It attacks using a two-inch poison barb on its head. It can usually be found under the leaves it eats.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	local CrystalEntry = display.newText("The barb on top of its head secretes a strong poison. It uses this toxic barb to protect itself.", display.contentWidth/2, 400,310,0,right, native.systemFont, 15)
