...
-- Beedrill page 3 for the pokedex
...
local previousPage = widget.newButton(
	...
	local GoldEntry = display.newText("It can take down any opponent with its powerful poison stingers. It sometimes attacks in swarms.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	local SilverEntry = display.newText("It has three poison barbs. The barb on its tail secretes the most powerful poison.", display.contentWidth/2, 320,310,0,right, native.systemFont, 15)
	...
	local CrystalEntry = display.newText("It uses sharp, poisonous stings to defeat prey, then takes the victim back to its nest for food.", display.contentWidth/2, 400,310,0,right, native.systemFont, 15)
