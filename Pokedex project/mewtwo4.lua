...
local previousPage = widget.newButton(
	...
	local rseEntry = display.newText("	Mewtwo is a Pokémon that was created by genetic manipulation. However, even though the scientific power of humans created this Pokémon's body, they failed to endow Mewtwo with a compassionate heart.", display.contentWidth/2, 160,312,0,right, native.systemFont, 15)
	rseEntry:setFillColor (0,0,0)
	sceneGroup: insert(rseEntry)
	
	--dimond pearl and platinum
	local dpp = display.newText("   Diamond, Pearl and Platinum Pokedex \n                          entries:", display.contentWidth/2, 320,310,0,center, native.systemFont, 17)
	dpp:setFillColor (0,0,0)
	sceneGroup: insert(dpp)
	local dppEntry = display.newText("A Pokémon created by recombining Mew's genes. It's said to have the most savage heart among Pokémon.", display.contentWidth/2, 370,310,0,right, native.systemFont, 15)
