...
local previousPage = widget.newButton(
	...
	local rseEntry = display.newText("Weedle has an extremely acute sense of smell. It is capable of distinguishing its favorite kinds of leaves from those it \n\n\n\n\n\ndislikes just by sniffing with its big red proboscis (nose).", display.contentWidth/2, 230,312,0,right, native.systemFont, 15)
	...
	local dppEntry = display.newText("It eats its weight in leaves every day. It fends off attackers with the needle on its head.", display.contentWidth/2, 395,310,0,right, native.systemFont, 15)
