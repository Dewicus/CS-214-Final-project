...
-- Metapod page 5 for the pokedex
...
local previousPage = widget.newButton(
	...
	local blEntry = display.newText("A steel-hard shell protects its tender body. It quietly endures hardships while awaiting evolution.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(x)
	local xEntry = display.newText("A steel-hard shell protects its tender body. It quietly endures hardships while awaiting evolution.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(y)
	local yEntry = display.newText("This Pokémon is vulnerable to attack while its shell is soft, exposing its weak and tender body.", display.contentWidth/2, 405,310,0,right, native.systemFont, 15)
