...
local previousPage = widget.newButton(
	...
	local blEntry = display.newText("Because it is able to use every move, there are many scientists who believe that it is the ancestor of all Pokémon.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(x)
	local xEntry = display.newText("Because it can use all kinds of moves, many scientists believe Mew to be the ancestor of Pokémon.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	xEntry:setFillColor (0,0,0)
	sceneGroup: insert(xEntry)
	
	local y = display.newText("Y pokedex entry:", display.contentWidth/2, 360, native.systemFont, 17)
	y:setFillColor (0,0,0)
	sceneGroup: insert(y)
	local yEntry = display.newText("Its DNA is said to contain the genetic codes of all Pokémon, so it can use all kinds of techniques.", display.contentWidth/2, 395,310,0,right, native.systemFont, 15)
