...
-- Beedrill page 4 for the pokedex
...
local previousPage = widget.newButton(
	...
	local rse = display.newText("Ruby, Sapphire and Emerald Pokedex	\n                          entries:", display.contentWidth/2, 135,310,0, native.systemFont, 17, "center") 
	rse:setFillColor (0,0,0)
	sceneGroup: insert(rse)
	local rseEntry = display.newText("Beedrill is extremely territorial. No one should ever approach its nest - this is for \n\n\n\n\n\ntheir own safety. If angered, they will attack in a furious swarm.", display.contentWidth/2, 238,312,0,right, native.systemFont, 15)
	...
	local dppEntry = display.newText("Its best attack involves flying around at high speed, striking with poison needles, then flying off.", display.contentWidth/2, 395,310,0,right, native.systemFont, 15)
