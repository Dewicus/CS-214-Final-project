...
-- Squirtle page 4 for the pokedex
...
local previousPage = widget.newButton(
	...
	local rseEntry = display.newText("Squirtle's shell is not merely used for protection. The shell's rounded shape and the grooves on its surface help minimize \n\n\n\n\n\nresistance in water, enabling this Pokémon to swim at high speeds.", display.contentWidth/2, 230,312,0,right, native.systemFont, 15)
	...
	local dppEntry = display.newText("It shelters itself in its shell, then strikes back with spouts of water at every opportunity.", display.contentWidth/2, 395,310,0,right, native.systemFont, 15)
