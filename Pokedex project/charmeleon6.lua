...
-- Charmeleon page 6 for the pokedex
...
local function handleButtonEvent( event )
    if ( "ended" == event.phase ) then
		composer.gotoScene("charmeleon7")
...
local function handlepreviousPageEvent (event)
	if  ( "ended" == event.phase) then 
		composer.gotoScene("charmeleon5")
	end
end
...
local previousPage = widget.newButton(
	...
	--Stats entries
	local basestats = display.newText("Charmeleon base stats:", display.contentWidth/2, 110, native.systemFont, 17)
	...
	local basestatsEntry = display.newText("58 \n64 \n58 \n\n\n\n\n\n\n80 \n65 \n80 \n405", display.contentWidth*(11/16), 250, native.systemFont, 15)
	basestatsEntry:setFillColor (0,0,0)
	sceneGroup: insert(basestatsEntry)
