...
local previousPage = widget.newButton(
	...
	--size and type data
	local types = display.newText("Types: Psychic. \n\nHeight: 6 feet and 7 inches    Weight 269 lbs \n\nGender ratio: Genderless", display.contentWidth/2, 155, native.systemFont, 15)
	types:setFillColor (0,0,0)
	sceneGroup: insert(types)        
									  --Bulbasuar               Ivysaur                   level                      Venusaur             level
	local Evolution = display.newText("Mewtwo does not evolve into any other pokemon.", display.contentWidth/2, 305, 310,0,right, native.systemFont, 15)
	Evolution:setFillColor (0,0,0)
	sceneGroup: insert(Evolution)						
	--or none can be typed in if no types
	local weakness = display.newText("Mewtwo is (2x damage) weak to Bug, Ghost, and Dark types. \nIt is immune to None. \nIt is resistant (1/2x damage) to Fighting and Psychic.", display.contentWidth/2, 380 ,310,0, right, native.systemFont, 15)
