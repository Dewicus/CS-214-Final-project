...
-- Venusaur page 4 for the pokedex
...
local previousPage = widget.newButton(
	...
	local rseEntry = display.newText("There is a large flower on Venusaur's back. The flower is said to take on vivid colors if it gets plenty of nutrition and sunlight. The \n\n\n\n\n\nflower's aroma soothes the emotions of people.", display.contentWidth/2, 230,312,0,right, native.systemFont, 15)
	...
	local dppEntry = display.newText("After a rainy day, the flower on its back smells stronger. The scent attracts other Pokémon.", display.contentWidth/2, 405,310,0,right, native.systemFont, 15)
