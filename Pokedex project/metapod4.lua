...
-- Metapod page 4 for the pokedex
...
local previousPage = widget.newButton(
	...
	local rseEntry = display.newText("The shell covering this Pokémon's body is as hard as an iron slab. Metapod does not move very much. It stays still because it is \n\n\n\n\n\npreparing its soft innards for evolution inside the hard shell.", display.contentWidth/2, 230,312,0,right, native.systemFont, 15)
	...
	local dppEntry = display.newText("A steel-hard shell protects its tender body. It quietly endures hardships while awaiting evolution.", display.contentWidth/2, 400,310,0,right, native.systemFont, 15)
