...
-- Venusaur page 6 for the pokedex
...
local previousPage = widget.newButton(
	...
	--Stats entries
	local basestats = display.newText("Venusaur base stats:", display.contentWidth/2, 110, native.systemFont, 17)
	...
	local basestatsEntry = display.newText("80 \n82 \n83 \n\n\n\n\n\n\n100 \n100 \n80 \n525", display.contentWidth*(11/16), 250, native.systemFont, 15)
	basestatsEntry:setFillColor (0,0,0)
	sceneGroup: insert(basestatsEntry)
