...
-- Caterpie page 4 for the pokedex
...
local previousPage = widget.newButton(
	...
	local rseEntry = display.newText("Caterpie has a voracious appetite. It can devour leaves bigger than its body right before your eyes. From its antenna, this Pokémon releases a terrifically strong odor.", display.contentWidth/2, 160,312,0,right, native.systemFont, 15)
	...
	local dppEntry = display.newText("It releases a stench from its red antenna to repel enemies. It grows by molting repeatedly.", display.contentWidth/2, 370,310,0,right, native.systemFont, 15)
