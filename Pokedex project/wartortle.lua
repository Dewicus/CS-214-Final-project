...
local previousPage = widget.newButton(
	...
	--size and type data
	local types = display.newText("Types: Water. \n\nHeight: 3 feet and 3 inches    Weight 49.6 lbs \n\nGender ratio: 87.5% are male, 12.5% are \nfemale", display.contentWidth/2, 155, native.systemFont, 15)
	types:setFillColor (0,0,0)
	sceneGroup: insert(types)
	local Evolution = display.newText("Wartortle evolves into Blastoise at level 36.", display.contentWidth/2, 305, 310,0,right, native.systemFont, 15)
	Evolution:setFillColor (0,0,0)
	sceneGroup: insert(Evolution)
	local weakness = display.newText("Wartortle is (2x damage) weak to Grass and electric types. \nIt is immune to none. \nIt is resistant (1/2x damage) to steel, fire, water, and ice.", display.contentWidth/2, 380 ,310,0, right, native.systemFont, 15)
