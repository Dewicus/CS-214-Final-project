...
local previousPage = widget.newButton(
	...
	local redblueEntry = display.newText("A strange seed was planted on its back at  birth. The plant sprouts and grows with this Pokemon.", display.contentWidth/2, 170, 310,0,right,native.systemFont, 15)
	...
	local yellowEntry = display.newText("It can go for days without eating a single morsel. In the bulb on its back, it stores energy.", display.contentWidth/2, 350,310,0,right, native.systemFont, 15)
