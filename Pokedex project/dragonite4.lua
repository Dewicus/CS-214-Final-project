...
-- Dragonite page 4 for the pokedex
...
local previousPage = widget.newButton(
	...
	local rseEntry = display.newText("Dragonite is capable of circling the globe in just sixteen hours. It is a kindhearted Pokémon that leads lost and foundering ships in a storm to the safety of land.", display.contentWidth/2, 160,312,0,right, native.systemFont, 15)
	...
	local dppEntry = display.newText("It is said to make its home somewhere in the sea. It guides crews of shipwrecks to shore.", display.contentWidth/2, 370,310,0,right, native.systemFont, 15)
