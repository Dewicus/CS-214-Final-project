...
-- Caterpie page 5 for the pokedex
...
local previousPage = widget.newButton(
	...
	local blEntry = display.newText("It releases a stench from its red antenna to repel enemies. It grows by molting repeatedly.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(x)
	local xEntry = display.newText("For protection, it releases a horrible stench from the antennae on its head to drive away enemies.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(y)
	local yEntry = display.newText("Its feet have suction cups designed to stick to any surface. It tenaciously climbs trees to forage.", display.contentWidth/2, 405,310,0,right, native.systemFont, 15)
