...
-- Squirtle page 3 for the pokedex
...
local previousPage = widget.newButton(
	...
	local GoldEntry = display.newText("The shell is soft when it is born. It soon becomes so resilient, prodding fingers will bounce off it.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	local SilverEntry = display.newText("The shell, which hardens soon after it is born, is resilient. If you poke it, it will bounce back out.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	local CrystalEntry = display.newText("When it feels threatened, it draws its legs inside its shell and sprays water from its mouth.", display.contentWidth/2, 400,310,0,right, native.systemFont, 15)
