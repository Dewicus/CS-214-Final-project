...
-- Venusaur page 7 for the pokedex
...
local previousPage = widget.newButton(
	...
	local backdrop = display.newRect(display.contentWidth*(2/4), display.contentHeight * (2.1/4), display.contentWidth*(7.9/8), display.contentHeight * (4.95/8))
