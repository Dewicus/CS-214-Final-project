...
local previousPage = widget.newButton(
	...
	--size and type data
	local types = display.newText("Types: Bug and flying. \n\nHeight: 3 feet and 7 inches    Weight 70.5 lbs \n\nGender ratio: 50% are male, 50% are \nfemale", display.contentWidth/2, 150, native.systemFont, 15)
	types:setFillColor (0,0,0)
	sceneGroup: insert(types)
	local Evolution = display.newText("Butterfree is the final evolution of Caterpie and Metapod.", display.contentWidth/2, 305, 310,0,right, native.systemFont, 15)
	Evolution:setFillColor (0,0,0)
	sceneGroup: insert(Evolution)
	local weakness = display.newText("Butterfree is (2x damage) weak to flying, fire ice and electric types. It is 4x weak to Rock. \nIt is immune to ground. \nIt is resistant (1/2x damage) to bug. It takes 1/4 damage from grass and Fighting.", display.contentWidth/2, 375 ,310,0, right, native.systemFont, 15)
