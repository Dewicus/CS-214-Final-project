...
-- Blastoise page 6 for the pokedex
...
local previousPage = widget.newButton(
	...
	--Stats entries
	local basestats = display.newText("Blastoise base stats:", display.contentWidth/2, 120, native.systemFont, 17)
	...
	local basestatsEntry = display.newText("79 \n83 \n100 \n\n\n\n\n\n\n85 \n105 \n78 \n530", display.contentWidth*(11/16), 250, native.systemFont, 15)
	basestatsEntry:setFillColor (0,0,0)
	sceneGroup: insert(basestatsEntry)
