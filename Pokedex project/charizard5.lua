...
-- Charizard page 5 for the pokedex
...
local previousPage = widget.newButton(
	...
	local blEntry = display.newText("It is said that Charizard's fire burns hotter if it has experienced harsh battles.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(x)
	local xEntry = display.newText("When expelling a blast of superhot fire, the red flame at the tip of its tail burns more intensely.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(y)
	local yEntry = display.newText("Its wings can carry this Pokémon close to an altitude of 4,600 feet. It blows out fire at very high temperatures.", display.contentWidth/2, 405,310,0,right, native.systemFont, 15)
