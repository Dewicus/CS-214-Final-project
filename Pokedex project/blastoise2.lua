...
-- Blastoise page 1 for the pokedex
...
local previousPage = widget.newButton(
	...
	local redblueEntry = display.newText("A brutal Pokémon with pressurized water jets on its shell. They are used for high speed tackles.", display.contentWidth/2, 170, 310,0,right,native.systemFont, 15)
	...
	local yellowEntry = display.newText("Once it takes aim at its enemy, it blasts out water with even more force than a fire hose.", display.contentWidth/2, 360,310,0,right, native.systemFont, 15)
