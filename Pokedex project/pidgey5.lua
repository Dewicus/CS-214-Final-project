...
local previousPage = widget.newButton(
	...
	local blEntry = display.newText("It is docile and prefers to avoid conflict. If disturbed, however, it can ferociously strike back.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(x)
	local xEntry = display.newText("A common sight in forests and woods. It flaps its wings at ground level to kick up blinding sand.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(y)
	local yEntry = display.newText("It is docile and prefers to avoid conflict. If disturbed, however, it can ferociously strike back.", display.contentWidth/2, 405,310,0,right, native.systemFont, 15)
