...
local previousPage = widget.newButton(
	...
	local rseEntry = display.newText("Pidgey has an extremely sharp sense of direction. It is capable of unerringly returning home to its nest, however far it may be removed from its familiar surroundings.", display.contentWidth/2, 170,312,0,right, native.systemFont, 15)
	...
	local dppEntry = display.newText("It is docile and prefers to avoid conflict. If disturbed, however, it can ferociously strike back.", display.contentWidth/2, 370,310,0,right, native.systemFont, 15)
