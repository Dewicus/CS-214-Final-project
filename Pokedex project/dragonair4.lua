...
-- Dragonair page 4 for the pokedex
...
local previousPage = widget.newButton(
	...
	local rseEntry = display.newText("Dragonair stores an enormous amount of energy inside its body. It is said to alter weather conditions in its vicinity by discharging energy from the crystals on its neck and tail.", display.contentWidth/2, 160,312,0,right, native.systemFont, 15)
	...
	local dppEntry = display.newText("If its body takes on an aura, the weather changes instantly. It is said to live in seas and lakes.", display.contentWidth/2, 370,310,0,right, native.systemFont, 15)
