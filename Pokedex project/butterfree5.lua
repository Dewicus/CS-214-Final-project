...
-- Butterfree page 5 for the pokedex
...
local function handleButtonEvent( event )
    if ( "ended" == event.phase ) then
		composer.gotoScene("butterfree6")
...
local previousPage = widget.newButton(
	...
	local blEntry = display.newText("It loves the honey of flowers and can locate flower patches that have even tiny amounts of pollen.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(x)
	local xEntry = display.newText("It loves the honey of flowers and can locate flower patches that have even tiny amounts of pollen.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(y)
	local yEntry = display.newText("The wings are protected by rain-repellent dust. As a result, this Pokémon can fly about even in rain.", display.contentWidth/2, 405,310,0,right, native.systemFont, 15)
