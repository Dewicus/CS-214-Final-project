...
-- Wartortle page 4 for the pokedex
...
local previousPage = widget.newButton(
	...
	local rseEntry = display.newText("Its tail is large and covered with a rich, thick fur. The tail becomes increasingly deeper in color as Wartortle ages. The scratches on \n\n\n\n\n\nits shell are evidence of this Pokémon's toughness as a battler.", display.contentWidth/2, 230,312,0,right, native.systemFont, 15)
	...
	local dppEntry = display.newText("It is said to live 10,000 years. Its furry tail is popular as a symbol of longevity.", display.contentWidth/2, 390,310,0,right, native.systemFont, 15)
