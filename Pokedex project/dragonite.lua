...
-- Dragonite page 1 for the pokedex
...
local previousPage = widget.newButton(
	...
	--size and type data
	local types = display.newText("Types: Dragon and Flying. \n\nHeight: 7 feet and 3 inches    Weight 463 lbs \n\nGender ratio: 50% are male, 50% are \nfemale", display.contentWidth/2, 155, native.systemFont, 15)
	...
	local weakness = display.newText("Dragonite is (4x damage) weak to Ice. \It is (2x damage) weak to Rock, Dragon, and Fairy types. \nIt is immune to Ground. \nIt is resistant (1/2x damage) to Fighting, Bug, Fire, Water and Grass.", display.contentWidth/2, 380 ,310,0, right, native.systemFont, 15)
