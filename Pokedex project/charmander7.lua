...
-- Charmander page 7 for the pokedex
...
local previousPage = widget.newButton(
	...
	--levels
	local lvl = display.newText("Level: \n\n   1\n   1\n   7\n   10\n   16\n   19\n   25\n   28\n   34\n   37\n   43\n   46\n", display.contentWidth/10, display.contentHeight/1.7777, native.systemFont, 13)
	lvl:setFillColor (0,0,0)
	sceneGroup: insert(lvl)
	--Attack name
	local move = display.newText("       Move:\n\n      Scratch\n       Growl\n      Ember\n Smokescreen\n Dragon Rage\n  Scary Face\n   Fire Fang\n Flame Burst\n       Slash\n Flamethrower\n    Fire Spin\n     Inferno\n", display.contentWidth*(3/10), 270, native.systemFont, 13)
	move:setFillColor (0,0,0)
	sceneGroup: insert(move)
	--move type
	local Type = display.newText(" Type:\n\nNormal\nNormal\n Fire\n Normal\nDragon\n Normal\n Fire\n Fire\nNormal\n Fire\n Fire\n Fire\n", display.contentWidth*(5.3/10), display.contentHeight/1.7777, native.systemFont, 13)
	...
	--move power points
	local pp = display.newText(" PP:\n\n 35\n 40\n 25\n 20\n 10\n 10\n 15\n 15\n 20\n 15\n 15\n  5\n", display.contentWidth*(9.5/10), display.contentHeight/1.7777, native.systemFont, 13)
