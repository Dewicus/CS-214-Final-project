...
-- Butterfree page 7 for the pokedex
...
local previousPage = widget.newButton(
	...
	local backdrop = display.newRect(display.contentWidth*(2/4), display.contentHeight * (2.12/4), display.contentWidth*(7.9/8), display.contentHeight * (5/8))
	...
	--levels
	local lvl = display.newText("Level: \n\n   1\n   10\n   12\n   12\n   12\n   16\n   18\n   22\n   24\n   28\n   30\n   34\n   36\n   40\n   42\n   46\n", display.contentWidth/10, display.contentHeight/1.8, native.systemFont, 13)
	lvl:setFillColor (0,0,0)
	sceneGroup: insert(lvl)
	--Attack name
	local move = display.newText("       Move:\n\n    Confusion\n    Confusion\n Poison Powder\n   Stun Spore\n Sleep Poowder\n        Gust\n   Supersonic\n    Whirlwind\n     Psybeam\n    Silver Wind\n      Tailwind\n  Rage Powder\n   Safeguard\n    Captivate\n    Bug Buzz\n Quiver Dance\n", display.contentWidth*(3/10), display.contentHeight/1.8, native.systemFont, 13)
	move:setFillColor (0,0,0)
	sceneGroup: insert(move)
	--move type
	local Type = display.newText(" Type:\n\nPsychic\nPsychic\n Poison\n Grass\n Grass\n Flying\nNormal\nNormal\nPsychic\n   Bug\n Flying\n   Bug\nNormal\nNormal\n   Bug\n   Bug", display.contentWidth*(5.3/10), display.contentHeight/1.8, native.systemFont, 13)
	Type:setFillColor (0,0,0)
	sceneGroup: insert(Type)
	--power of move
	local power = display.newText("Power:\n\n\ 50\n 50\n\n\n\n 40\n\n\n 65\n 60\n\n\n\n\n 90\n\n", display.contentWidth*(6.8/10), display.contentHeight/1.8, native.systemFont, 13)
	power:setFillColor (0,0,0)
	sceneGroup: insert(power)
	--move accuracy
	local accuracy = display.newText(" Acc.:\n\n100%\n100%\n 75%\n 75%\n 75%\n100%\n 55%\n100%\n100%\n100%\n\n\n\n\n100%\n100%\n", display.contentWidth*(8.2/10), display.contentHeight/1.8, native.systemFont, 13)
	accuracy:setFillColor (0,0,0)
	sceneGroup: insert(accuracy)
	--move power points
	local pp = display.newText(" PP:\n\n 25\n 25\n 35\n 30\n 15\n 35\n 20\n 20\n 20\n  5\n 30\n 20\n 25\n 20\n 10\n 20", display.contentWidth*(9.5/10), display.contentHeight/1.8, native.systemFont, 13)
