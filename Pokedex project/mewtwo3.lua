...
local previousPage = widget.newButton(
	...
	local GoldEntry = display.newText("Because its battle abilities were raised to the ultimate level, it thinks only of defeating its foes.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	local SilverEntry = display.newText("It usually remains motionless to conserve energy, so that it may unleash its full power in battle.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	local CrystalEntry = display.newText("	Said to rest quietly in an undiscovered cave, this Pokémon was created solely for battling.", display.contentWidth/2, 400,310,0,right, native.systemFont, 15)
