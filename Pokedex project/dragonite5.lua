...
-- Dragonite page 5 for the pokedex
...
local previousPage = widget.newButton(
	...
	local blEntry = display.newText("It is said to make its home somewhere in the sea. It guides crews of shipwrecks to shore.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(x)
	local xEntry = display.newText("It can fly in spite of its big and bulky physique. It circles the globe in just 16 hours.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(y)
	local yEntry = display.newText("It is said to make its home somewhere in the sea. It guides crews of shipwrecks to shore.", display.contentWidth/2, 395,310,0,right, native.systemFont, 15)
