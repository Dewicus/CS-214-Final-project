...
-- Dratini page 5 for the pokedex
...
local previousPage = widget.newButton(
	...
	local blEntry = display.newText("It is called the 'Mirage Pokémon' because so few have seen it. Its shed skin has been found.", display.contentWidth/2, 175,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(x)
	local xEntry = display.newText("It is called the 'Mirage Pokémon' because so few have seen it. Its shed skin has been found.", display.contentWidth/2, 330,310,0,right, native.systemFont, 15)
	...
	sceneGroup: insert(y)
	local yEntry = display.newText("This Pokémon is full of life energy. It continually sheds its skin and grows steadily larger.", display.contentWidth/2, 395,310,0,right, native.systemFont, 15)
