...
-- Blastoise page 4 for the pokedex
...
local previousPage = widget.newButton(
	...
	local rseEntry = display.newText("Blastoise has water spouts that protrude from its shell. The water spouts are very accurate. They can shoot bullets of water \n\n\n\n\n\nwith enough accuracy to strike empty cans from a distance of over 160 feet.", display.contentWidth/2, 230,312,0,right, native.systemFont, 15)
	...
	local dppEntry = display.newText("The jets of water it spouts from the rocket cannons on its shell can punch through thick steel.", display.contentWidth/2, 390,310,0,right, native.systemFont, 15)
