...
local previousPage = widget.newButton(
	...
	--size and type data
	local types = display.newText("Types: Bug and poison. \n\nHeight: 1 feet and 0 inches    Weight 7.1 lbs \n\nGender ratio: 50% are male, 50% are \nfemale", display.contentWidth/2, 155, native.systemFont, 15)
	types:setFillColor (0,0,0)
	sceneGroup: insert(types)
	local Evolution = display.newText("Weedle evolves into Kakuna at level 7. \nIt then evolves into Beedrill at level 10.", display.contentWidth/2, 304, 310,0,right, native.systemFont, 15)
	Evolution:setFillColor (0,0,0)
	sceneGroup: insert(Evolution)
	local weakness = display.newText("Weedle is (2x damage) weak to flying, fire, psychic and rock. \nIt is immune to none. \nIt is resistant (1/2x damage) to poison, bug and fairy. It takes 1/4 damage from grass and fighting.", display.contentWidth/2, 378 ,310,0, right, native.systemFont, 15)
